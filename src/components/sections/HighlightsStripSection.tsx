...
/* -------------------------------------------------------------------------- */
/* Dados da faixa de destaques                                                */
/* Usa as 5 primeiras oportunidades e repete para o efeito de ticker.         */
/* -------------------------------------------------------------------------- */
const highlightItems = opportunities.slice(0, 5);

/* -------------------------------------------------------------------------- */
/* Faixa de destaques                                                         */
/* Aparece logo após o hero e antes da seção Sobre.                           */
/* -------------------------------------------------------------------------- */
export function HighlightsStripSection() {
	// Duplicamos a lista para a animação de rolagem contínua.
	...
	return (
		<section className="relative border-y border-white/10 bg-[linear-gradient(90deg,rgba(3,40,66,0.96),rgba(8,103,168,0.92))] px-4 py-4 text-white sm:px-5 sm:py-5">
			<div className="mx-auto max-w-7xl">
				...
				{/* ---------------------------------------------------------- */}
				{/* 2) Trilha animada com os cards de destaque                */}
				{/* ---------------------------------------------------------- */}
