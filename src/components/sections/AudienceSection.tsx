...
export function AudienceSection() {
	...
	return (
		<section id="publicos" className="bg-[#032842] px-5 py-20 text-white">
			<div className="mx-auto max-w-6xl"><div className="max-w-2xl"><p className="text-sm font-bold uppercase tracking-[0.18em] text-[#FFD45A]">Comece por aqui</p><h2 className="mt-3 text-4xl leading-tight sm:text-5xl">O que você está buscando?</h2><p className="mt-4 text-lg leading-8 text-white/75">Escolha o seu caminho e encontre as oportunidades mais relevantes sem precisar conhecer a estrutura da secretaria.</p></div>
