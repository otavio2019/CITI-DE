		...
		<section id="acesso-rapido" className="bg-[#032842] px-5 py-14 text-white sm:py-16">
			<div className="mx-auto max-w-6xl">
				<div className="flex flex-col justify-between gap-5 md:flex-row md:items-end">
					<div><p className="text-sm font-bold uppercase tracking-[0.18em] text-[#FFD45A]">Ações rápidas</p><h2 className="mt-2 text-3xl sm:text-4xl">Vá direto ao que precisa</h2></div>
